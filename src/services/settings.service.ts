            ...
            if (!currentSettings) {
                const initialConfig = {
                    dashboard: {
                        ...
                        canSeeRevenueReport: [],
                        canSeeFinancials: ['staff'], // Added financials to dashboard
                    },
                    patientManagement: {
                    ...
                    // --- UPDATED: Financials section with view permission ---
                    financials: {
                        canViewFinancialRecords: ['staff'],
                        canAddFinancialRecord: ['staff'],
